    ...
    <div id="main-content" class="main-content full-width">
      <div id="primary" class="content-area main-content-bg clearfix">
        <div id="content" class="site-content" role="main">
          <h3>
            <?php _e( 'Login', 'user-frontend-td' ); ?>
          </h3>
          <?php echo apply_filters( 'uf_login_messages', isset( $_GET[ 'message' ] ) ? $_GET[ 'message' ] : '' ); ?>
          <form action="<?php echo uf_get_action_url( 'login' ); ?>" method="post" id="user_login_form">
            ...
            <p>
              ...
              <input type="submit" name="submit" id="submit" class="consultantsubmitbutton" value="<?php _e( 'Submit', 'user-frontend-td' ); ?>">
            </p>
            <p> <a href="<?php echo home_url( '/user-forgot-password/' ); ?>">
